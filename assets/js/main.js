...
/*=============== TIME AND DATE TEXT ===============*/
const dateDayOfTheWeek = document.getElementById('date-dayOfTheWeek'),
      dateMonth = document.getElementById('date-month'),
      dateDay = document.getElementById('date-day'),
      dateYear = document.getElementById('date-year'),
      textHour = document.getElementById('text-hour'),
      textMins = document.getElementById('text-mins'),
      textSecs = document.getElementById('text-secs'),
...
const clockText = () =>{
    ...
    dateDayOfTheWeek.innerHTML = `${daysOfTheWeek[dayOfTheWeek]}`;
